...
//        netType = 2;
    ...
    public static String getNetworkType() {
        ConnectivityManager cm = (ConnectivityManager) GlobalApplication.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        return !TextUtils.isEmpty(GlobalApplication.user.getName()) && isNetworkAvailable();
//    }
}
