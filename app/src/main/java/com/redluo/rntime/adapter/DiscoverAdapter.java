...
public class DiscoverAdapter extends BaseQuickAdapter<NewsItem.DataListBean, BaseViewHolder> {
    public DiscoverAdapter(@Nullable List<NewsItem.DataListBean> data) {
        super(R.layout.recycler_item_content_discover, data);
