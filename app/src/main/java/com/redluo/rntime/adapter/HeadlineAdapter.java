...
public class HeadlineAdapter extends BaseQuickAdapter<NewsItem.DataListBean, BaseViewHolder> {
    public HeadlineAdapter(@Nullable List<NewsItem.DataListBean> data) {
        super(R.layout.recycler_item_content, data);
